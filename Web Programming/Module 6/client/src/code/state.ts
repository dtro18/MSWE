...
/**
 * This function must be called once and only once from BaseLayout. Returns an object.
 */
export function createState(inParentComponent: React.Component): any {
  ...
  if (stateSingleton === null) {
    ...
    stateSingleton = {
      ...
      // Corresponds to the middle of the screen. React requires the current view to render correctly.
      currentView : "welcome",
      ...
      addMailboxToList : function(inMailbox: IMAP.IMailbox): void {
        ...
        // When calling setState shouldn't pass refs to objects
