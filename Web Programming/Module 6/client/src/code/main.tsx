...
// Style imports, okay because webpack knows how to deal
// Normalize is a "css reset" meaning it normalizes across browsers
...
const startupFunction = function(): void {
  ...
  // Wait to grab contacts until we've grabbed the mailboxes
  // 
  getMailboxes().then(function(): void {
    ...
    // showHidePleaseWait is hidden again once we've rendered everything
