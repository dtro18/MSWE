...
public class EventBus {
    ...
    /**
     * Command event #7 definition: Check overbook. 
     */
    public static final int EV_CHECK_OVERBOOK = 7;

    /**
     * Command event #8 definition: Check registration validity. 
     */
    public static final int EV_REGISTER_VALID_STUDENT = 8;
